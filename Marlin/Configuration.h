...
#define STRING_CONFIG_H_AUTHOR "(Bartos, Tronxy XY-3 Custom)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Bartos-3D"
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -1.81   // Z offset: -below +above  [the nozzle]
